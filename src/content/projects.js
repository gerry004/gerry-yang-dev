...
},
{
  ...
  description: 'Cleaned and analysed housing price data, implemented a machine learning model to predict housing prices, compared the accuracy of various models, and visualised the results.',
