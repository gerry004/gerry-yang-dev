function Contact() {
  return (
    <div className="flex flex-col justify-center items-center bg-primary py-6">
      ...
      <p className="text-white text-center p-4">I'm always looking for exciting projects to work on and interesting people to chat with, so don't hesitate to shot me an email! @gerry04y@gmail.com</p>
